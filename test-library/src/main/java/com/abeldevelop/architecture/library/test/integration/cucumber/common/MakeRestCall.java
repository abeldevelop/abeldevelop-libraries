...
public class MakeRestCall {
    ...
    private void makeRestCall(HttpMethod method) throws Exception {
        ...
        try {
            String endpoint = testContext.getRequestBaseUrl() + testContext.getRequestEndpoint();
            log.debug(CucumberTestConstants.INTEGRATION_TEST + "RestTemplate REQUEST url: {}", endpoint);
            ...
            ResponseEntity<String> response = new RestTemplate().exchange(endpoint, method, requestHttpEntity, String.class);
